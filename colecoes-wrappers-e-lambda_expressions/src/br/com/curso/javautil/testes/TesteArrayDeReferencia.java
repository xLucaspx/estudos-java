...
import br.com.curso.javautil.modelos.Cliente;
...
//		System.out.println(contasC[2].getNumero()); // NullPointerException; não definimos contas na posição 2, então mão podemos chamar o metodo
//		System.out.println(contasC[3].getNumero()); // ArrayIndexOutOfBoundsException; nosso array só vai até a posição 2
...
//		ContaCorrente ref2 = contas[0]; // assim não compila pois o tipo do array é Conta; temos que avisar o compilador com type casting:
		ContaCorrente ref2 = (ContaCorrente) contas[0];
		
//		ContaPoupanca ref3 = (ContaPoupanca) contas[1]; // ClassCastException; tentando fazer type casting de uma CC em uma CP
...
//		System.out.println(referenciaGenerica.getNumero()); // não compila pois Object não possui o metodo getNumero
		
		ContaPoupanca referenciaEspecifica = (ContaPoupanca) referencias[2];
//		System.out.println(referenciaEspecifica.getNumero()); // funciona pois agora a referencia é para uma CP, que possui o metodo
