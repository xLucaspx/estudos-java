package br.com.curso.collections.modelos;
...
//		return aulas.stream().mapToInt(Aula::getTempo).sum(); // caso tempoTotal não fosse um atributo de curso
		return tempoTotal;
	}
...
//		throw new NoSuchElementException("Matricula " + numero + " não encontrada");
	...
	public String toString() {
		return "Curso " + nome + ", instrutor " + instrutor + ", " + quantidadeDeAulas + " aulas, " + quantidadeDeAlunos + " alunos, tempo total: " + tempoTotal + " minutos";
	}
}
