...
public class PublisherList extends javax.swing.JFrame {
  ...
  private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
    try {
      ...
      JOptionPane.showMessageDialog(this, String.format("Erro ao tentar abrir o formulário de alteração de editora:\n%s", e.getMessage()), getTitle(), JOptionPane.ERROR_MESSAGE);
    }
  ...
  private void refreshBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshBtnActionPerformed
    try {
      ...
      JOptionPane.showMessageDialog(this, String.format("Erro ao tentar atualizar a tabela de editoras:\n%s", e.getMessage()), getTitle(), JOptionPane.ERROR_MESSAGE);
    }
  ...
  private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
    try {
      ...
      int res = JOptionPane.showOptionDialog(this, String.format("Tem certeza que deseja excluir a editora %s?\nNão é possível desfazer esta ação!", selectedPublisher.getName()), getTitle(), JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[1]);
