...
public class InternalGenreForm extends javax.swing.JInternalFrame {
  private final GenreController genreController;
  private Genre genre;

  public InternalGenreForm(ControllerFactory controllerFactory) {
    this.genreController = controllerFactory.getGenreController();
    initComponents();
  }

  public InternalGenreForm(ControllerFactory controllerFactory, Genre genre) {
    this.genreController = controllerFactory.getGenreController();
    this.genre = genre;
    initComponents();
  }
  ...
  private void initComponents() {
    ...
    saveBtn.setToolTipText(genre != null ? String.format("Editar a categoria %s", genre.getName()) : "Cadastrar nova categoria");
  ...
  private void createGenre(String name) {
    ...
    JOptionPane.showMessageDialog(this, "Categoria cadastrada com sucesso!", getTitle(), JOptionPane.INFORMATION_MESSAGE);
  }

  private void updateGenre(int id, String newName) {
    genreController.update(id, newName);
    JOptionPane.showMessageDialog(this, "Categoria atualizada com sucesso!", getTitle(), JOptionPane.INFORMATION_MESSAGE);
  }
