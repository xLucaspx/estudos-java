...
public class GenreForm extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		setTitle(genre != null ? "Alteração de categoria" : "Cadastro de categoria");
		...
		title.setText(genre != null ? "Alterar categoria" : "Cadastrar categoria");
		...
		saveBtn.setToolTipText(
				genre != null ? String.format("Alterar a categoria %s", genre.getName()) : "Cadastrar nova categoria");
		saveBtn.setActionCommand("Salvar");
		saveBtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
		saveBtn.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		saveBtn.setLabel(genre != null ? "Editar" : "Cadastrar");
				...
				.addGroup(layout.createSequentialGroup()
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addGroup(layout.createSequentialGroup().addGap(5, 5, 5).addComponent(nameLabel))
										.addComponent(title, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(nameInput, javax.swing.GroupLayout.PREFERRED_SIZE, 270,
												javax.swing.GroupLayout.PREFERRED_SIZE))
	...
	private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveBtnActionPerformed
		...
		try {
			if (genre != null) {
				genreController.update(genre.getId(), name);
