package br.com.curso.java8.testes;
...
import br.com.curso.java8.modelos.Curso;
...
public class TesteStream {
	...
	public static void main(String[] args) {
		...
		// mapToInt devolve um IntStream (proprio para int), enquanto map devolve um Stream<Integer> e precisa fazer boxing
